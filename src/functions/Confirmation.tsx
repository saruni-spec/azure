...
export async function BuyGoods(
  ...
  try {
    ...
    return fetch("https://sandbox.safaricom.co.ke/mpesa/c2b/v1/registerurl", {
      method: "POST",
      headers,
      body: JSON.stringify({
        ShortCode: 600997,
        ResponseType: "Completed",
        ConfirmationURL: "https://bossbox.azurewebsites.net/api/BuyGoods",
        ValidationURL: "https://bossbox.azurewebsites.net/api/Confirm",
      }),
    })
